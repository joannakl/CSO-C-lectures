#include <stdio.h>
/*
 * This program illustrates how to pass pointer parameters to functions. 
 * This is just an alternative version of sum.c program.
 * 
...
//The start of the array is indicated by the pointer a. 
